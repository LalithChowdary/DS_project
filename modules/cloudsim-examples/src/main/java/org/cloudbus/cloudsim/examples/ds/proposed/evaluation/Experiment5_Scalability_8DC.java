...
public class Experiment5_Scalability_8DC {

    public static void main(String[] args) {
        Log.printLine("Starting Experiment 5: Scalability Analysis (8 Datacenters)...");
        ...
        try {
            ...
            int vmsPerDC = 10;
            int totalTasks = 2000;
            int tasksPerLB = totalTasks / numDCs; // 250
            ...
            Log.printLine("");
            Log.printLine("==========================================");
            Log.printLine("Results for Scalability Experiment (8 DCs)");
            Log.printLine("==========================================");
            ...
            Log.printLine("Experiment 5 (8 DCs) Finished.");
        } catch (Exception e) {
            e.printStackTrace();
